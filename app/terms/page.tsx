    ...
    <div className="min-h-screen bg-[#060E1C] text-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 pt-28 pb-20">
        ...
        <div className="space-y-10 font-sans text-slate-400 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-white font-display font-black uppercase tracking-widest text-base mb-3">7. Third-Party Data &amp; Attribution</h2>
            <p>CardIQ integrates with the following third-party services. Your use of these services is also subject to their respective terms of service and data policies:</p>
            <ul className="list-disc list-inside mt-3 space-y-2 ml-2">
              <li><strong className="text-chrome-300">eBay:</strong> Pricing data sourced from the eBay Browse API and Finding API. eBay® is a registered trademark of eBay Inc. CardIQ is not affiliated with or endorsed by eBay.</li>
              <li><strong className="text-chrome-300">BallDontLie:</strong> NBA player statistics provided by the BallDontLie API (<a href="https://www.balldontlie.io" className="text-gold-400 hover:text-gold-300 transition-colors" target="_blank" rel="noopener noreferrer">balldontlie.io</a>).</li>
              <li><strong className="text-chrome-300">ESPN:</strong> NFL, NHL, Soccer, and Golf statistics sourced from ESPN APIs. ESPN® is a registered trademark of ESPN, Inc. CardIQ is not affiliated with or endorsed by ESPN.</li>
              <li><strong className="text-chrome-300">MLB Stats API:</strong> Baseball statistics provided by the official MLB Stats API. MLB® trademarks and copyrights are used with permission of Major League Baseball. Visit <a href="https://www.mlb.com" className="text-gold-400 hover:text-gold-300 transition-colors" target="_blank" rel="noopener noreferrer">MLB.com</a>.</li>
              <li><strong className="text-chrome-300">NHL API:</strong> Hockey statistics sourced from the official NHL API. NHL® is a registered trademark of the National Hockey League.</li>
              <li><strong className="text-chrome-300">Anthropic Claude:</strong> AI-generated signals and analysis powered by Anthropic's Claude models.</li>
              <li><strong className="text-chrome-300">Clerk, Neon, Vercel, Resend:</strong> Authentication, database, hosting, and email infrastructure.</li>
            </ul>
            <p className="mt-3">We are not responsible for the accuracy, completeness, or timeliness of data provided by any third-party service. All trademarks are the property of their respective owners.</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3"><strong className="text-chrome-300">AI signals are not financial advice.</strong> BUY, SELL, and HOLD signals generated by CardIQ are for informational and entertainment purposes only. They do not constitute investment advice, a solicitation to buy or sell any asset, or a guarantee of future performance. Sports card markets are speculative and illiquid. You may lose some or all of the money you invest in trading cards.</p>
            <p className="mt-3">To the maximum extent permitted by law, CardIQ shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the service, including any financial losses resulting from reliance on AI-generated signals or pricing data.</p>
          </section>
