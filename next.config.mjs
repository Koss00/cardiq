...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy',     value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://clerk.accounts.dev https://*.clerk.accounts.dev https://*.clerk.com https://www.google.com https://www.gstatic.com",
      ...
      "frame-src https://accounts.google.com https://www.google.com https://accounts.facebook.com https://clerk.accounts.dev https://*.clerk.accounts.dev",
